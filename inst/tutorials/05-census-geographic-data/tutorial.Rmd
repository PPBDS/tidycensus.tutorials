...
<!-- ```{r tigris-workflows-8-test, include = FALSE} -->
<!-- library(patchwork) -->
<!-- ``` -->
...
<!-- Load the [**glue**](https://glue.tidyverse.org/) package. -->
...
<!-- ```{r tigris-workflows-9-test, include = FALSE} -->
<!-- library(glue) -->
<!-- ``` -->
...
<!-- ```{r tigris-workflows-10-test, include = FALSE} -->
<!-- nrow(us_bgs_2020) -->
<!-- ``` -->
