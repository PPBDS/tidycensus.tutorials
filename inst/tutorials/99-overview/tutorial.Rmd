...
In this exercise, you will use an AI assistant (such as ChatGPT) to generate R code to collect data.

Open your AI and tell it to use tidycensus to get data on the median household income for all counties in Texas for 2020.
