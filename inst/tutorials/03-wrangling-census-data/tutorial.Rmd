...
In the tidyverse, split-apply-combine is implemented with the group_by() function. The az_race_percent dataset is an example of a dataset suitable for group-wise data analysis.  Pipe the dataset `az_race_percent` to the function `group_by()` passing in `NAME` as an argument
