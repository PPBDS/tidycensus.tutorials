...
<!-- Not sure where this is in the book, but leaving it here for now. Really need to save copies of this data and not download it live each time. -->
...
```{r plots-of-moe-1-hint-1, eval = FALSE}
get_acs(state = "...",
        geography = "...",
...
```{r plots-of-moe-2, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r plots-of-moe-2-hint-1, eval = FALSE}
get_acs(state = "...",
        geography = "...",
        variables = c(hhincome = "..."),
        year = ...) |> 
...
```{r plots-of-moe-3, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r plots-of-moe-3-hint-1, eval = FALSE}
... |> 
  ggplot(aes(x = ..., 
...
```{r plots-of-moe-4, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r plots-of-moe-4-hint-1, eval = FALSE}
... +
...
```{r plots-of-moe-5, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r plots-of-moe-5-hint-1, eval = FALSE}
... +
  scale_x_continuous(labels = scales::label_dollar())
```
...
```{r plots-of-moe-6-hint-1, eval = FALSE}
... + 
  labs(...)
```
...
```{r plots-of-moe-7-hint-1, eval = FALSE}
years <- 2005:2019
```
...
```{r plots-of-moe-8, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r plots-of-moe-8-hint-1, eval = FALSE}
library(...)
```
...
```{r plots-of-moe-9, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r plots-of-moe-9-hint-1, eval = FALSE}
names(years) <- years
map_dfr(years)
```
...
```{r plots-of-moe-10, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r plots-of-moe-10-hint-1, eval = FALSE}
...
map_dfr(years,  ~{
  get_acs(
    geography = "...",
...
```{r plots-of-moe-11, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r plots-of-moe-11-hint-1, eval = FALSE}
...
map_dfr(years,  ~{
  get_acs(geography = "...",
    variables = "...",
...
```{r plots-of-moe-12, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r plots-of-moe-12-hint-1, eval = FALSE}
... +
...
```{r plots-of-moe-13, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r plots-of-moe-13-hint-1, eval = FALSE}
... + 
  geom_line() +
  geom_point()
```
...
```{r plots-of-moe-14, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r plots-of-moe-14-hint-1, eval = FALSE}
... + 
...
```{r plots-of-moe-15, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r plots-of-moe-15-hint-1, eval = FALSE}
... + 
...
```{r plots-of-moe-16, exercise = TRUE}

```

<button onclick = "transfer_code(this)">Copy previous code</button>

```{r plots-of-moe-16-hint-1, eval = FALSE}
... + 
  scale_y_continuous(labels = scales::label_dollar(scale = .001, suffix = "k"))
```
...
```{r plots-of-moe-17-hint-1, eval = FALSE}
... + 
  labs(...)
```
