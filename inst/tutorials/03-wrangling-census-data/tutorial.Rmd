...
<!-- SU: Is the bottom paragraph needed? it contradicts itself -->
We would normally do this analysis by just piping `median_age` into `arrange(estimate)`, producing the same answer as here.
...
Copying the code above, lets change the `year` to `2018`, and `19` to `18`. 
