...
<!-- DK: Use the modern pipe |> throughout. -->
...
<!-- DK: Fix formatting. Space between ### and Topic title. One blank row around titles, and code chunk and text. -->
...
Pipe the previous code into the function `filter()` setting `percent` to `max()` `percent` as an argument
