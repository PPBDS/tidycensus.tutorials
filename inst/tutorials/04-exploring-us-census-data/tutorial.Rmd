...
```{r basic-census-visualization-wit-2-test, include = FALSE}
get_acs(
  geography = "county",
  state = "Georgia",
...
<!-- GK: Using quadratic regression should be more appropriate -->
...
<!-- GK: I delete the test case to avoid saving multiple times. -->
